      ...
      object tbsInfo: TTabSheet
        ...
        object Memo1: TMemo
          ...
          Lines.Strings = (
            ...
            'Main Treeview:'
            ''
            '- While SHIFT key is pressed, skip building references for all '
            'plugins.'
            ...
            'View treeview:'
            ''
            '- Ctrl + UP/DOWN to reorder Form Lists.'
            ''
            'Modgroups:'
            ''
            ...
            ''
            #39'+'#39' The file is optional'
            #39'-'#39' The mod must be present in that order. Records from it wont '
            'be hidden.'
            ''
            '[Modgroup Name]'
            'MainPlugin.esm'
            ...
            'have always enabled'#8230' But as long as that assumption holds true, '
            'it can declutter the reported conflicts significantly.'
            '')
          ParentColor = True
          ParentFont = False
          ReadOnly = True
